...
- [ ] T002 Initialize Rust project(s) with Cargo (workspace or crate per plan)
- [ ] T003 [P] Configure linting and formatting tools (`cargo fmt`, `cargo clippy`)
- [ ] T004 [P] Configure CI to run `cargo test`, `cargo fmt -- --check`, `cargo clippy -- -D warnings`, and `cargo audit`
